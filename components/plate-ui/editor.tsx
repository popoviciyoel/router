...
const editorVariants = cva(
  cn(
    ...
    'rounded-md ring-offset-white placeholder:text-gray-500/80 focus-visible:outline-none dark:ring-offset-gray-950 dark:placeholder:text-gray-400/80',
    '[&_[data-slate-placeholder]]:text-gray-500/80 [&_[data-slate-placeholder]]:!opacity-100 dark:[&_[data-slate-placeholder]]:text-gray-400/80',
