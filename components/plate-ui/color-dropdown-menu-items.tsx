  ...
  const content = (
    <DropdownMenuItem
      className={cn(
        ...
        'my-1 flex size-6 items-center justify-center rounded-full border border-gray-200 border-solid border-gray-100 p-0 transition-all hover:scale-125 dark:border-gray-800',
