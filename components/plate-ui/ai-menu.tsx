...
export function AIMenu() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={false}>
      ...
      >
        <Command
          className='w-full rounded-lg border border-gray-200 shadow-md dark:border-gray-800'
          value={value}
        ...
        >
          ...
          {isLoading ? (
            <div className='flex grow select-none items-center gap-2 p-2 text-sm text-gray-500 dark:text-gray-400'>
            ...
            <InputCommand
              variant='ghost'
              className='rounded-none border-b border-solid border-gray-200 [&_svg]:hidden dark:border-gray-800'
              value={input}
              onKeyDown={(e) => {
