              ...
              <Tooltip key={id}>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    variant='ghost'
                    className={cn(
                      'h-fit rounded-full fill-current p-1.5 text-gray-500 hover:bg-gray-100 hover:text-gray-500 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-400',
                      id === focusedCategory &&
                        'pointer-events-none bg-gray-100 fill-current text-gray-900 dark:bg-gray-800 dark:text-gray-50'
                    )}
                    onClick={() => {
                      onClick(id);
                    }}
